...
public class UnitTestColorHash {
    ...
    public void testQuadraticProbing() {
		System.out.println("start testQuadraticProbing");
		makeCollidingKeys();
    	...
    	assertEquals(v, 6L);
    	System.out.println("finish testQP");
    }
	
	@Test
	public void testQuadraticProbingAndResizing() {
		System.out.println("start testQuadraticProbingAndResizing");
	...
	public void testResponseItemsForQuadraticProbingAndResizing() {
		System.out.println("start testResponseItemsForQuadraticProbingAndResizing");
		testQuadraticProbing(); // Sets up the table to just before resizing.
